...
function postInstantiate(extendedExports, instance) {
  ...
  const memory = exports$1.memory;
  const table = exports$1.table;
  const __new = exports$1["__new"];
  const __retain = exports$1["__retain"];
  const __rtti_base = exports$1["__rtti_base"] || -1; // oob if not present
  ...
  return demangle(exports$1, extendedExports);
}
...
async function instantiate(source, imports = {}) {
  ...
  const exports$1 = postInstantiate(extended, instance);
  return { module, instance, exports: exports$1 };
}
...
async function instantiateStreaming(source, imports = {}) {
  ...
  const exports$1 = postInstantiate(extended, result.instance);
  return { ...result, exports: exports$1 };
}

/** Demangles an AssemblyScript module's exports to a friendly object structure. */
function demangle(exports$1, extendedExports = {}) {
  const setArgumentsLength = exports$1["__argumentsLength"]
    ? length => { exports$1["__argumentsLength"].value = length; }
    : exports$1["__setArgumentsLength"] || exports$1["__setargc"] || (() => { /* nop */ });
  for (let internalName in exports$1) {
    if (!Object.prototype.hasOwnProperty.call(exports$1, internalName)) continue;
    const elem = exports$1[internalName];
    ...
    if (hash >= 0) {
      ...
      if (/^(get|set):/.test(name)) {
        if (!Object.prototype.hasOwnProperty.call(curr, name = name.substring(4))) {
          let getter = exports$1[internalName.replace("set:", "get:")];
          let setter = exports$1[internalName.replace("get:", "set:")];
      ...
      if (/^(get|set):/.test(name)) {
        if (!Object.prototype.hasOwnProperty.call(curr, name = name.substring(4))) {
          Object.defineProperty(curr, name, {
            get: exports$1[internalName.replace("set:", "get:")],
            set: exports$1[internalName.replace("get:", "set:")],
            enumerable: true
          });
        }
...
class Renderer {
  constructor(gl, audio, opts) {
    ...
    this.speed = opts.speed || 1.0; // Animation speed multiplier
    this.blending = false;
  ...
  calcTimeAndFPS(elapsedTime) {
    ...
    this.time += (1.0 / this.fps) * this.speed;
